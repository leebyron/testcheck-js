 ...
 */
class testcheck$Generator<T> {}

declare module "testcheck" {
  declare type Generator<T> = Class<testcheck$Generator<T>>;
   ...
   *
   */
  declare function property<A,B,C,D>(
    gens: [
      Generator<A>,
      Generator<B>,
      Generator<C>,
